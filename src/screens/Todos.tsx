...
export default function Todos() {
  ...
  // A routine is never "done" as a whole, so progress reads its CURRENT occurrence instead — that
  // way a day with every routine ticked still counts as finished (and still earns the confetti).
  ...
  return (
    <div className="pt-[calc(0.4rem+env(safe-area-inset-top))]">
      ...
      {/* repeat editor — serves both the quick-add draft and the to-do being edited */}
      <RoutineSheet
