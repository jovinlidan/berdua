...
export interface Routine {
  ...
  weekdays?: number[] // weekly only — 0=Sun … 6=Sat (defaults to the start day's weekday)
 ...
 * last-write-wins clobbering them — both partners can check off different days while offline.
 */
