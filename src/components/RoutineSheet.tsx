...
export function RoutineSheet({
  ...
  // query, so any unrelated write re-creates that object — reacting to it would wipe an edit
  // in progress.
  ...
  // A weekly rule with every weekday switched off can't land anywhere — block saving it.
